...
# which carries both the raw questionnaire items and the pre-scored subscales.
RAW_DIARY_DAY = DATA_RAW / "diary_day.sav"
RAW_DIARY_MORNING = DATA_RAW / "diary_morning.sav"
RAW_DIARY_EVENING = DATA_RAW / "diary_evening.sav"
RAW_BASELINE_SAV = DATA_RAW / "baseline_between.sav"
