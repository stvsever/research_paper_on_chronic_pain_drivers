...
#
# Why: within-person network modelling of the drivers of pain is only justified if a
# meaningful share of variance lives WITHIN persons (and within days). This stage partitions
# the variance of pain and each candidate driver into:
#   - between persons,
...
# intercepts (lme4). Output feeds the main variance-decomposition figure and table.
...
vars <- c(PIJN = "Pain intensity", THREAT = "Threat value", ATTEND = "Attention to pain",
          ENGAGE = "Goal engagement", EFFIC = "Goal efficacy", VALENCE = "Activity valence")
...
cat("\nInterpretation: 'var_within_day' is the share of variance available to the\n",
    "moment-to-moment (lag-1) network. Substantial within-person variance in pain and its\n",
    "drivers justifies the idiographic within-person modelling that follows.\n", sep = "")
